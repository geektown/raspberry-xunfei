...
int main(int argc, char* argv[])
{
	...
	*/
	...
	const char* filename             = argv[1]; // "tts_sample.wav"; //合成的语音文件名称
	const char* text                 = argv[2]; //"亲爱的用户，您好，这是一个语音合成示例，感谢您对科大讯飞语音技术的支持！科大讯飞是亚太地区最大的语音上市公司，股票代码：002230"; //合成文本
    // printf("first params is wave file, and the second is text.");
	/* 用户登录 */
